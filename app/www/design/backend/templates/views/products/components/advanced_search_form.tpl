{split data=$filter_features size="2" assign="splitted_filter" preverse_keys=true}
    ...
    <tbody>
        ...
        {foreach from=$filters_row item="filter"}
            ...
            {if $filter && $filter.feature_type}
                ...
                <td width="350px" data-th="{$filter.filter|default:$filter.description}">
                    {if $filter.feature_type == "ProductFeatures::TEXT_SELECTBOX"|enum
                        ...
                        <div class="object-selector object-selector--mobile-full-width object-selector--half-width">
                            ...
                            <select id="{$prefix}variants_{$id}"
                                    ...
                                    multiple
                                    name="{$data_name}[{$id}][]"
                                    data-ca-placeholder={__("admin_search_field")}
