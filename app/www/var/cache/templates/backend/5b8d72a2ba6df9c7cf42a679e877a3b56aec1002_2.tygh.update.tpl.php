...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_66850531347910_33091720',
...
function content_66850531347910_33091720 (Smarty_Internal_Template $_smarty_tpl) {
...
" name="result_ids">
 ...
 product-category" id="product_categories">
                                    ...
                                    <?php if ($_REQUEST['category_id']) {?>
                                        <?php $_smarty_tpl->_assignInScope('request_category_id', explode(",",$_REQUEST['category_id']));?>
                                    <?php }?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
                    ...
                    <?php if (trim($_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'select_options_type')) && trim($_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'select_exceptions_type'))) {?>
...
" class="input-small cm-value-decimal" />
                                        </div>
                                    </div>
                                <?php $_block_repeat=false;
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
                ...
                <?php if (trim(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'product_extra')))) {?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>                 <?php }?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['has_global_individual_settings_permission']->value) {?>
                    ...
                    <div class="well well-small help-block">
                        <?php echo $_smarty_tpl->__("global_individual.additional_settings",array("[settings_url]"=>fn_url("settings.manage&section_id=Checkout"),"[icon]"=>"<i class=\"icon-sitemap\"></i>"));?>
