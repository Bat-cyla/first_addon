...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_667c177ccbfde2_62225598',
...
function content_667c177ccbfde2_62225598 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php if ($_smarty_tpl->tpl_vars['show_addon_status']->value) {?>
    <?php $_smarty_tpl->_assignInScope('target_id', "addons_list,header_navbar,header_subnav,addons_counter,elm_developer_pages,elm_all_dev_pages");?>
...
echo htmlspecialchars((string) fn_url("addons.update_status?id=".((string)$_smarty_tpl->tpl_vars['key']->value)."&status=".$_prefixVariable40."&redirect_url=".((string)(rawurlencode((string)$_smarty_tpl->tpl_vars['c_url']->value)))), ENT_QUOTES, 'UTF-8');?>
"
