<?php
/* Smarty version 4.1.1, created on 2024-05-17 08:33:36
  from '/app/www/design/backend/templates/views/tools/view_changes.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6646ec30d93502_87935578',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '95b152d31bcc320dd1f6310863af96dd34e705fa' => 
    array (
      0 => '/app/www/design/backend/templates/views/tools/view_changes.tpl',
      1 => 1693486476,
      2 => 'tygh',
    ),
  ),
...
function content_6646ec30d93502_87935578 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/app/www/app/functions/smarty_plugins/modifier.formatfilesize.php','function'=>'smarty_modifier_formatfilesize',),1=>array('file'=>'/app/www/app/functions/smarty_plugins/modifier.date_format.php','function'=>'smarty_modifier_date_format',),2=>array('file'=>'/app/www/app/functions/smarty_plugins/block.inline_script.php','function'=>'smarty_block_inline_script',),));
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <?php if ($_smarty_tpl->tpl_vars['compare_data']->value['file_path']) {?>
                        <b><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['compare_data']->value['file_path'], ENT_QUOTES, 'UTF-8');?>
...
echo htmlspecialchars((string) fn_url("tools.create_snapshot?redirect_url=".$_prefixVariable1), ENT_QUOTES, 'UTF-8');?>
    ...
    <?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "sidebar", null, null);?>
        <div class="sidebar-row">
            ...
            <p>
                ...
                <?php } else { ?>
                    <?php if ($_smarty_tpl->tpl_vars['creation_time']->value) {?><span class="muted"><?php echo htmlspecialchars((string) smarty_modifier_date_format($_smarty_tpl->tpl_vars['creation_time']->value,((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['date_format']).", ".((string)$_smarty_tpl->tpl_vars['settings']->value['Appearance']['time_format'])), ENT_QUOTES, 'UTF-8');?>
</span><?php }?>
                <?php }?>
            </p>
            <hr />
...
>
        Tygh.$(document).ready(function(){
            Tygh.$('#on_changes_<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['changes_tree_keys']->value[0], ENT_QUOTES, 'UTF-8');?>
').click();
        }
        );
    <?php echo '</script'; ?>
