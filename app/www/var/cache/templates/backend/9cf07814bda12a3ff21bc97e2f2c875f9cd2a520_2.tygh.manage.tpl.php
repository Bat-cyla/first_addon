<?php
/* Smarty version 4.1.1, created on 2024-06-19 08:03:18
  from '/app/www/design/backend/templates/addons/vendor_plans/views/vendor_plans/manage.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_667266962600d2_70511249',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9cf07814bda12a3ff21bc97e2f2c875f9cd2a520' => 
    array (
      0 => '/app/www/design/backend/templates/addons/vendor_plans/views/vendor_plans/manage.tpl',
      1 => 1716808809,
      2 => 'tygh',
    ),
  ),
...
function content_667266962600d2_70511249 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/app/www/app/functions/smarty_plugins/function.script.php','function'=>'smarty_function_script',),1=>array('file'=>'/app/www/app/functions/smarty_plugins/function.include_ext.php','function'=>'smarty_function_include_ext',),2=>array('file'=>'/app/www/app/functions/smarty_plugins/modifier.to_json.php','function'=>'smarty_modifier_to_json',),3=>array('file'=>'/app/www/app/functions/smarty_plugins/modifier.enum.php','function'=>'smarty_modifier_enum',),4=>array('file'=>'/app/www/app/functions/smarty_plugins/block.hook.php','function'=>'smarty_block_hook',),));
\Tygh\Languages\Helper::preloadLangVars(array('position_short','name','price','vendor_plans.best_choise_short','vendors','status','position_short','name','price','vendor_plans.best_choise_short','vendors','tools','edit','delete','status','no_data','preview','vendor_plans.new_vendor_plan','vendor_plans.add_vendor_plan','vendor_plans.vendor_plans'));
...
">
                            <?php if ($_smarty_tpl->tpl_vars['has_management_permissions']->value) {?>
                                <a class="row-status cm-external-click" data-ca-external-click-id="<?php echo htmlspecialchars((string) "opener_plan_".((string)$_smarty_tpl->tpl_vars['plan']->value['plan_id']), ENT_QUOTES, 'UTF-8');?>
">
                            <?php }?>
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "buttons", null, null);?>
    <?php if ($_smarty_tpl->tpl_vars['plans']->value && $_smarty_tpl->tpl_vars['has_management_permissions']->value) {?>
        <?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "tools_items", null, null);?>
            <li><?php $_smarty_tpl->smarty->ext->_tplFunction->callTemplateFunction($_smarty_tpl, 'btn', array('type'=>"list",'target'=>"_blank",'text'=>$_smarty_tpl->__("preview"),'href'=>$_smarty_tpl->tpl_vars['preview_uri']->value), true);?>
</li>
        <?php $_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
        <?php $_smarty_tpl->smarty->ext->_tplFunction->callTemplateFunction($_smarty_tpl, 'dropdown', array('content'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'tools_items')), true);?>


        <?php $_smarty_tpl->_subTemplateRender("tygh:buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('but_name'=>"dispatch[vendor_plans.m_update]",'but_role'=>"submit-button",'but_target_form'=>"vendor_plans_form",'but_meta'=>"bulkedit-disable-save-button"), 0, false);
?>
    <?php }
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "adv_buttons", null, null);?>
    <?php if ($_smarty_tpl->tpl_vars['has_management_permissions']->value) {?>
        <?php $_smarty_tpl->_subTemplateRender("tygh:common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('id'=>"add_new_usergroups",'text'=>$_smarty_tpl->__("vendor_plans.new_vendor_plan"),'title'=>$_smarty_tpl->__("vendor_plans.add_vendor_plan"),'href'=>fn_url("vendor_plans.add"),'act'=>"general",'icon'=>"icon-plus"), 0, true);
?>
    <?php }
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
