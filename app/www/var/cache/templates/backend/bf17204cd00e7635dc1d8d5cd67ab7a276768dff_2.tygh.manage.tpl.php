...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
    ...
    <?php if (fn_allowed_for("MULTIVENDOR")) {?>
        <?php $_smarty_tpl->smarty->_cache['_tag_stack'][] = array('hook', array('name'=>"companies:manage_invite_vendors"));
$_block_repeat=true;
echo smarty_block_hook(array('name'=>"companies:manage_invite_vendors"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
            <?php $_smarty_tpl->_subTemplateRender("tygh:buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('but_role'=>"text",'but_href'=>"companies.invite",'title'=>$_smarty_tpl->__("invite_vendors_title"),'but_text'=>$_smarty_tpl->__("invite_vendors"),'but_meta'=>"btn cm-dialog-opener"), 0, false);
?>
        <?php $_block_repeat=false;
echo smarty_block_hook(array('name'=>"companies:manage_invite_vendors"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
    <?php }
...
ob_start();?>
        <?php if ($_smarty_tpl->tpl_vars['is_companies_limit_reached']->value || fn_allowed_for("ULTIMATE:FREE")) {?>
            ...
            <?php $_smarty_tpl->_subTemplateRender("tygh:common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('tool_override_meta'=>"btn cm-dialog-opener cm-dialog-auto-height",'tool_href'=>"functionality_restrictions.ultimate_or_storefront_license_required",'prefix'=>"top",'hide_tools'=>true,'title'=>$_smarty_tpl->tpl_vars['add_vendor_text']->value,'icon'=>"icon-plus",'meta_data'=>"data-ca-dialog-title='".((string)$_smarty_tpl->tpl_vars['promo_popup_title']->value)."'"), 0, false);
?>
        <?php } else { ?>
            <?php $_smarty_tpl->_subTemplateRender("tygh:common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('tool_href'=>"companies.add",'prefix'=>"top",'hide_tools'=>true,'title'=>$_smarty_tpl->tpl_vars['add_vendor_text']->value,'icon'=>"icon-plus"), 0, true);
?>
        <?php }?>
    <?php $_block_repeat=false;
