<?php
/* Smarty version 4.1.1, created on 2024-07-05 16:42:24
  from '/app/www/design/backend/templates/addons/cp_extended_tags/views/cp_extended_tags/manage.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6687f8402c7521_65648932',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e6ed0c8a7830ffc3d014180cb45dfa71eaf28da2' => 
    array (
      0 => '/app/www/design/backend/templates/addons/cp_extended_tags/views/cp_extended_tags/manage.tpl',
      1 => 1720186941,
      2 => 'tygh',
    ),
  ),
  ...
  array (
    ...
    'tygh:addons/cp_extended_tags/views/cp_extended_tags/components/tags_search_form.tpl' => 1,
    'tygh:common/mainbox.tpl' => 1,
  ),
),false)) {
function content_6687f8402c7521_65648932 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "mainbox", null, null);?>
    ...
    <?php $_smarty_tpl->_assignInScope('object_type', $_smarty_tpl->tpl_vars['object_type']->value);?>
...
" method="post" name="cp_extended_tags_form">
...
?>
        <?php if ($_smarty_tpl->tpl_vars['tags']->value) {?>
            ...
            <?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "cp_extended_tags_table", null, null);?>
...
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
                            ...
                            <th width="8%" class="center">
                                <a class="cm-ajax"
                                   href="<?php echo htmlspecialchars((string) fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=popularity&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'UTF-8');?>
"
                                   data-ca-target-id="pagination_contents">
                                    <?php if ($_smarty_tpl->tpl_vars['object_type']->value == 'O') {?>
                                    ...
                                    <?php }?>
                                    <?php if ($_smarty_tpl->tpl_vars['search']->value['sort_by'] == "popularity") {
echo $_smarty_tpl->tpl_vars['c_icon']->value;
} else {
echo $_smarty_tpl->tpl_vars['c_dummy']->value;
}?>
...
"
                                   data-ca-target-id="pagination_contents"><?php echo $_smarty_tpl->__('order_list_display');?>
...
">
                                <input type="text" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['tag']->value['tag'], ENT_QUOTES, 'UTF-8');?>
" size="20" class="input-hidden">
                            ...
                            <td width="8%" >
                                ...
                                <td class="center" width="8%" >
                                    <input type="hidden" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['tag']->value['tag_id'], ENT_QUOTES, 'UTF-8');?>
" name="tags_ids[]">
                                <input type="checkbox" name="active_tags_ids[]" value="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['tag']->value['tag_id'], ENT_QUOTES, 'UTF-8');?>
"
...
">
                                <div class="hidden-tools">
                                    <?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "tools_list", null, null);?>
                                        <li><?php $_smarty_tpl->smarty->ext->_tplFunction->callTemplateFunction($_smarty_tpl, 'btn', array('type'=>"list",'class'=>"cm-confirm",'text'=>$_smarty_tpl->__("delete"),'href'=>"cp_extended_tags.delete?tag_id=".((string)$_smarty_tpl->tpl_vars['tag']->value['tag_id'])."?object_type=".((string)$_smarty_tpl->tpl_vars['object_type']->value),'method'=>"POST"), true);?>
</li>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
            ...
            <?php $_smarty_tpl->_subTemplateRender("tygh:common/context_menu_wrapper.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('form'=>"cp_extended_tags_form",'object'=>"cp_extended_tags",'items'=>$_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'cp_extended_tags_table')), 0, false);
?>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['tags']->value) {?>
        <?php $_smarty_tpl->_subTemplateRender("tygh:buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('but_name'=>"dispatch[cp_extended_tags.m_update]",'but_role'=>"submit-link",'but_target_form'=>"cp_extended_tags_form"), 0, false);
?>
    <?php }
...
<?php $_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "sidebar", null, null);?>
    <?php $_smarty_tpl->_subTemplateRender("tygh:addons/cp_extended_tags/views/cp_extended_tags/components/tags_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('dispatch'=>"cp_extended_tags.manage"), 0, false);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
