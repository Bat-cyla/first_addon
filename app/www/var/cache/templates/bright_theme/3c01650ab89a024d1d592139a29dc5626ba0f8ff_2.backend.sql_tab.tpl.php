<?php
/* Smarty version 4.1.1, created on 2024-06-28 09:50:59
  from '/app/www/design/backend/templates/views/debugger/components/sql_tab.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_667e5d530c2bb1_74466712',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3c01650ab89a024d1d592139a29dc5626ba0f8ff' => 
    array (
      0 => '/app/www/design/backend/templates/views/debugger/components/sql_tab.tpl',
      1 => 1716808809,
      2 => 'backend',
    ),
  ),
...
function content_667e5d530c2bb1_74466712 (Smarty_Internal_Template $_smarty_tpl) {
    ...
    <div class="deb-sub-tab-content" id="DebugToolbarSubTabSQLList">
        ...
        <div class="table-wrapper">
            <table class="deb-table" id="DebugToolbarSubTabSQLListTable">
                <caption>Queries
                    <small class="deb-font-gray">total time: <?php echo htmlspecialchars((string) number_format($_smarty_tpl->tpl_vars['data']->value['totals']['time'],"5"), ENT_QUOTES, 'UTF-8');?>
 s.</small>
                </caption>
                <tr>
...
"<?php }?> style="width: 60px;"><strong><?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['query']->value['count'], ENT_QUOTES, 'UTF-8');?>
                        ...
                        <td <?php if ($_smarty_tpl->tpl_vars['color']->value) {?>class="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['color']->value, ENT_QUOTES, 'UTF-8');?>
"<?php }?> style="width: 60px;"><strong><?php echo htmlspecialchars((string) number_format($_smarty_tpl->tpl_vars['query']->value['min_time'],"5"), ENT_QUOTES, 'UTF-8');?>
</strong></td>
                        <td <?php if ($_smarty_tpl->tpl_vars['color']->value) {?>class="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['color']->value, ENT_QUOTES, 'UTF-8');?>
"<?php }?> style="width: 60px;"><strong><?php echo htmlspecialchars((string) number_format($_smarty_tpl->tpl_vars['query']->value['max_time'],"5"), ENT_QUOTES, 'UTF-8');?>
</strong></td>
                        <td <?php if ($_smarty_tpl->tpl_vars['color']->value) {?>class="<?php echo htmlspecialchars((string) $_smarty_tpl->tpl_vars['color']->value, ENT_QUOTES, 'UTF-8');?>
"<?php }?> style="width: 120px;"><strong><?php echo htmlspecialchars((string) number_format($_smarty_tpl->tpl_vars['average_time']->value,"5"), ENT_QUOTES, 'UTF-8');?>
</strong></td>
                    </tr>
                <?php
}
