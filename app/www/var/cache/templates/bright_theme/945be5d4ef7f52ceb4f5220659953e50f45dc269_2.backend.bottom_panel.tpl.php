<?php
/* Smarty version 4.1.1, created on 2024-05-13 11:48:02
  from '/app/www/design/backend/templates/components/bottom_panel/bottom_panel.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.1.1',
  'unifunc' => 'content_6641d3c2b21014_38632992',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '945be5d4ef7f52ceb4f5220659953e50f45dc269' => 
    array (
...
echo htmlspecialchars((string) fn_url("bottom_panel.redirect?url=".((string)(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url'])))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&to_area=C".$_prefixVariable2,$_smarty_tpl->tpl_vars['redirect_area']->value), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars((string) fn_url("customization.disable_mode?type=live_editor&return_url=".$_prefixVariable3), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "theme") {?>
                            href="<?php ob_start();
echo htmlspecialchars((string) urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable4=ob_get_clean();
echo htmlspecialchars((string) fn_url("customization.disable_mode?type=theme_editor&return_url=".$_prefixVariable4), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "build") {?>
                            href="<?php ob_start();
echo htmlspecialchars((string) urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable5=ob_get_clean();
echo htmlspecialchars((string) fn_url("customization.disable_mode?type=block_manager&return_url=".$_prefixVariable5), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } else { ?>
...
echo htmlspecialchars((string) fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_prefixVariable6), ENT_QUOTES, 'UTF-8');?>
"
...
echo htmlspecialchars((string) fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_prefixVariable7), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
...
echo htmlspecialchars((string) fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_prefixVariable8), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
                            id="settings_block_manager"
...
echo htmlspecialchars((string) fn_url('',"A"), ENT_QUOTES, 'UTF-8');
            ...
            class="bp-logo"
            data-bp-tooltip="true">
            <?php $_smarty_tpl->_subTemplateRender("backend:common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('image'=>$_smarty_tpl->tpl_vars['logo']->value,'image_css_class'=>"bp-logo-img--no-color",'show_detailed_link'=>false), 0, true);
?>
            <div class="bp-tooltip bp-tooltip--left">
            <?php if ((defined('ACCOUNT_TYPE') ? constant('ACCOUNT_TYPE') : null) === "customer") {?>
                <?php echo $_smarty_tpl->__("bottom_panel.go_to_home_page");?>
...
echo htmlspecialchars((string) fn_url("bottom_panel.redirect?url=".((string)(urlencode($_smarty_tpl->tpl_vars['config']->value['current_url'])))."&area=".((string)(defined('AREA') ? constant('AREA') : null))."&to_area=C".$_prefixVariable9,$_smarty_tpl->tpl_vars['redirect_area']->value), ENT_QUOTES, 'UTF-8');?>
"
                class="bp-nav__item cm-no-ajax
                <?php if ((defined('ACCOUNT_TYPE') ? constant('ACCOUNT_TYPE') : null) === "customer") {?>
                    bp-nav__item--active
...
echo htmlspecialchars((string) fn_url("customization.disable_mode?type=live_editor&return_url=".$_prefixVariable10), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "theme") {?>
                            href="<?php ob_start();
echo htmlspecialchars((string) urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable11=ob_get_clean();
echo htmlspecialchars((string) fn_url("customization.disable_mode?type=theme_editor&return_url=".$_prefixVariable11), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } elseif ($_smarty_tpl->tpl_vars['active_mode']->value === "build") {?>
                            href="<?php ob_start();
echo htmlspecialchars((string) urlencode($_smarty_tpl->tpl_vars['config']->value['current_url']), ENT_QUOTES, 'UTF-8');
$_prefixVariable12=ob_get_clean();
echo htmlspecialchars((string) fn_url("customization.disable_mode?type=block_manager&return_url=".$_prefixVariable12), ENT_QUOTES, 'UTF-8');?>
"
                        <?php } else { ?>
                            href="<?php echo htmlspecialchars((string) fn_url(''), ENT_QUOTES, 'UTF-8');?>
"
                        ...
                        <?php if ($_smarty_tpl->tpl_vars['active_mode']->value === "preview") {?>bp-modes__item--active<?php }?>"
                            data-bp-modes-item="preview"
                            data-bp-tooltip="true">
                        <?php $_smarty_tpl->_subTemplateRender("backend:components/bottom_panel/icons/bp-modes__item--preview.svg", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
                        <div class="bp-tooltip"><?php echo $_smarty_tpl->__("bottom_panel.preview_mode");?>
</div>
                    </a>
...
echo htmlspecialchars((string) fn_url("customization.update_mode?type=live_editor&status=enable&return_url=".$_prefixVariable13), ENT_QUOTES, 'UTF-8');?>
"
                            id="settings_live_editor"
                            class="cm-no-ajax bp-modes__item bp-modes__item--text
                            <?php if ($_smarty_tpl->tpl_vars['active_mode']->value === "text") {?>bp-modes__item--active<?php }?>"
                            data-bp-modes-item="text"
                            data-bp-tooltip="true">
                            <?php $_smarty_tpl->_subTemplateRender("backend:components/bottom_panel/icons/bp-modes__item--text.svg", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
                            <div class="bp-tooltip"><?php echo $_smarty_tpl->__("bottom_panel.text_mode");?>
</div>
                        </a>
...
echo htmlspecialchars((string) fn_url("customization.update_mode?type=theme_editor&status=enable&return_url=".$_prefixVariable14), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
                            id="settings_theme_editor"
                            class="cm-no-ajax bp-modes__item bp-modes__item--theme
                            <?php if ($_smarty_tpl->tpl_vars['active_mode']->value === "theme") {?>bp-modes__item--active<?php }?>
                            ...
                            data-bp-modes-item="theme"
                            data-bp-tooltip="true">
                            <?php $_smarty_tpl->_subTemplateRender("backend:components/bottom_panel/icons/bp-modes__item--theme.svg", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
                            <div class="bp-tooltip">
                                <?php echo $_smarty_tpl->__("bottom_panel.theme_mode");?>
...
echo htmlspecialchars((string) fn_url("customization.update_mode?type=block_manager&status=enable&return_url=".$_prefixVariable15), ENT_QUOTES, 'UTF-8');
} else { ?>#<?php }?>"
                            id="settings_block_manager"
                            class="cm-no-ajax bp-modes__item bp-modes__item--build
                            <?php if ($_smarty_tpl->tpl_vars['active_mode']->value === "build") {?>bp-modes__item--active<?php }?>
                            ...
                            data-bp-modes-item="build"
                            data-bp-tooltip="true">
                            <?php $_smarty_tpl->_subTemplateRender("backend:components/bottom_panel/icons/bp-modes__item--build.svg", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
                            <div class="bp-tooltip">
                                <?php echo $_smarty_tpl->__("bottom_panel.build_mode");?>
        ...
        <div class="bp-actions <?php if (!trim($_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'settings_menu'))) {?>bp-actions--one-column<?php }?>">
            <?php if (trim($_smarty_tpl->smarty->ext->_capture->getBuffer($_smarty_tpl, 'settings_menu')) && (!fn_allowed_for("MULTIVENDOR:ULTIMATE") || empty($_smarty_tpl->tpl_vars['auth']->value['storefront_id']) || (int) $_smarty_tpl->tpl_vars['auth']->value['storefront_id'] === (int) $_smarty_tpl->tpl_vars['runtime']->value['storefront_id'])) {?>
                <div class="bp-dropdown bp-actions__item">
                    <button class="bp-dropdown-button bp-dropdown-button--animation" data-bp-toggle="dropdown"
                        data-bp-tooltip="true">
                        <?php $_smarty_tpl->_subTemplateRender("backend:components/bottom_panel/icons/bp-dropdown-button--settings.svg", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
                        <span class="bp-tooltip"><?php echo $_smarty_tpl->__("bottom_panel.settings");?>
</span>
                    </button>
            ...
            <?php if ($_smarty_tpl->tpl_vars['auth']->value['user_type'] !== smarty_modifier_enum("UserTypes::VENDOR")) {?>
                <div class="bp-dropdown bp-actions__item">
                    <button class="bp-dropdown-button" data-bp-toggle="dropdown" data-bp-tooltip="true">
                        <?php $_smarty_tpl->_subTemplateRender("backend:components/bottom_panel/icons/bp-dropdown-button--help.svg", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
                        <span class="bp-tooltip"><?php echo $_smarty_tpl->__("bottom_panel.help");?>
</span>
                    </button>
...
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
        ...
        <button id="bp_off_bottom_panel" class="bp-close"
            data-bp-tooltip="true"
            data-bp-save-state="true">
            <?php $_smarty_tpl->_subTemplateRender("backend:components/bottom_panel/icons/bp-close.svg", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?>
            <span class="bp-tooltip bp-tooltip--right"><?php echo $_smarty_tpl->__("bottom_panel.hide_bottom_admin_panel");?>
</span>
        </button>
